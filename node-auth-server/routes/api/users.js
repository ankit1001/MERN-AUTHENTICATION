...
const keys = require("../../config/dbCreds");
const passport = require("passport");

//Loading user input validation
...
router.post("/register", (req, res) => {
  debugger
  // Form validation
console.log("methoda called" + req + res);
...
router.post("/login", (req, res) => {
    ...
    const {errors, isValid} = validateUserLogin(req.body);  //Destructuring
